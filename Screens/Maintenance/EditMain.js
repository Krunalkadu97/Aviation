...
// create a component
const EdMaintenance = ({navigation,route}) => {
            ...
            <ScrollView style={{flex:1,padding:10}}>
                ...
                <View style={[styles.SectionStyle, { justifyContent: 'flex-start', marginLeft:30, marginTop: 1 }]}>
                        ...
                        <TouchableOpacity style={[styles.radBtn,{marginLeft:15}]}
                            ...
                            {
                                status === 'Completed' ? <Ionicons name='radio-button-on' color={COLORS.lightyellow} size={16} /> :
                                    <Ionicons name='radio-button-off' color='gray' size={16} />
                            }
                            <Text style={{ color: status === 'Completed' ? COLORS.white : 'gray', marginLeft: 10, fontWeight: status === 'Completed' ? 'bold' : '500', fontSize: status === 'Completed' ? 15 : 14 }}>Completed</Text>
                        </TouchableOpacity>
                    </View>
