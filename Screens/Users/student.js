    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 15 }}>
                <Text style={{ color: COLORS.white, fontWeight: 'bold', fontSize: 20 }}>Student</Text>
                ...
                onPress={()=>navigation.navigate('adduser',{role:'4'})}>
            ...
            <ScrollView style={{ flex: 1, backgroundColor: COLORS.darkgray, margin: 10, padding: 5 }}>
                {
                    data ? <View>
                        {
                            data.filter(e => e.US_RO_ID === '4').map((item, index) => (
                                        ...
                                        ind === index && action ?
                                            <View>
                                                <View style={styles.sep} />
                                                {
                                                    ...
                                                    <TouchableOpacity 
                                                    onPress={()=>navigation.navigate('edituser',{role:'4',item})}>
                        ...
                        {
                            data.filter(e => e.US_RO_ID === '4').length < 1 ?
                    ...
                    </View> : <Text style={{ color: COLORS.white,textAlign:'center' }}>No Data Found</Text>
                }
