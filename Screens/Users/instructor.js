...
// create a component
const InstructorUser = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 15 }}>
                <Text style={{ color: COLORS.white, fontWeight: 'bold', fontSize: 20 }}>Instructor</Text>
                ...
                }} onPress={()=>navigation.navigate('adduser',{role:'3'})}>
            ...
            <ScrollView style={{ flex: 1, backgroundColor: COLORS.darkgray, margin: 10, padding: 5 }}>
                {
                    data ? <View>
                        {
                            data.filter(e => e.US_RO_ID === '3').map((item, index) => (
                                        ...
                                        ind === index && action ?
                                            <View>
                                                ...
                                                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 10 }}>
                                                    <TouchableOpacity 
                                                    onPress={()=>navigation.navigate('edituser',{role:'3',item})}>
                                                        <FontAwesome name='edit' color={COLORS.white} size={25} />
                                                    </TouchableOpacity>
                                                    <TouchableOpacity onPress={()=>navigation.navigate('udetail',{item})}>
                                                        <Ionicons name='apps-sharp' color={COLORS.white} size={25} />
                                                    </TouchableOpacity>
                                                    <TouchableOpacity 
                                                    onPress={()=>navigation.navigate('iprice',{item})}>
                                                        <Ionicons name='md-pricetags' color={COLORS.white} size={25} />
                                                    </TouchableOpacity>
                                                    <TouchableOpacity 
                        ...
                        {
                            data.filter(e => e.US_RO_ID === '3').length < 1 ?
