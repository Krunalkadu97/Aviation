...
const AddAircraft = ({ navigation }) => {
    ...
    const Submit = () => {
        ...
        formdata.append("AI_ID", "");
        formdata.append("USER_ID", userid);
        formdata.append("USER_CO_ID", userCo);
        formdata.append("USER_RO_ID", userRo);
        formdata.append("AI_NAME", Bname);
        formdata.append("AI_MODEL", model);
        formdata.append("AI_TAIL_NO",tno);
        formdata.append("AI_ENGINE_TYPE", engine);
        formdata.append("AI_STATUS", status);
        ...
        fetch(BASE_URL+"/apis/admin/add_aircraft", requestOptions)
